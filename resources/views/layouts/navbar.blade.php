            ...
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    @if (Auth::user()->role == 'General Manager')
                        <li class="nav-item {{ $title == 'Tiket Keluhan' ? 'active' : '' }}">
                            <a class="nav-link" href="/tiket_keluhan">
                        ...
                        <li class="nav-item {{ $title == 'Tiket Layanan' ? 'active' : '' }}">
                            <a class="nav-link" href="/tiket_layanan">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li class="nav-item {{ $title == 'Data Agent' ? 'active' : '' }}">
                    ...
                    @if (Auth::user()->role == 'Agent')
                        <li
                            class="nav-item dropdown {{ $title == 'Tiket' || $title == 'Detail Tiket' ? 'active' : '' }}">
                            <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                                data-bs-auto-close="outside" role="button" aria-expanded="false">
                                <span
                                    class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
