        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{ $title == 'Kelola Akun' ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ $title == 'Kelola Tim' ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ $title == 'Kelola Jabatan' ? 'active' : '' }}">
                        <a class="nav-link" href="/jabatan">
                            <span
                                class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-pin"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" />
                    ...
                    <li class="nav-item {{ $title == 'Kelola Divisi' ? 'active' : '' }}">
                        <a class="nav-link" href="/divisi">
                            <span
                                class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map-pin-cog"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <li class="nav-item {{ $title == 'Kelola Dampak Permasalahan' ? 'active' : '' }}">
                        <a class="nav-link" href="/dampak_permasalahan">
                            <span
                                class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                    ...
                    <li class="nav-item {{ $title == 'Kelola Knowledgebase' ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ $title == 'Kelola Kategori Permasalahan' ? 'active' : '' }}">
                        <a class="nav-link" href="/kategori_masalah">
                            <span
                                class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-message-2-question" width="24"
