                                ...
                                @foreach ($jabatans as $jabatan)
                                    <tr class="align-middle">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/jabatan/{{ $jabatan->id }}" class="btn btn-info btn-icon"
                                                title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4 ">
                    ...
                    <div class="text-secondary">Apakah anda yakin ingin menghapus jabatan bernama <span class="fw-bolder"
                            id="nama"></span>
                        ?
                    </div>
                </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_jabatan') is-invalid @enderror"
                                        name="nama_jabatan" placeholder="Masukan Nama Jabatan"
