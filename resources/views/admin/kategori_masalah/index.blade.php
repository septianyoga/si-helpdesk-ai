                        ...
                        <table id="example" class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tim yang Menangani</th>
                                    {{-- <th>Akun</th> --}}
                                    <th class="text-center">Aksi</th>
                                </tr>
                            </thead>
                            <tbody class="table-tbody">
                                @foreach ($kategori_masalahs as $kategori)
                                    <tr class="align-middle">
                                        <td>{{ $loop->iteration }}.</td>
                                        <td>{{ $kategori->nama_topik }}</td>
                                        <td>{{ $kategori->tim != null ? $kategori->tim->nama_tim : '' }}</td>
                                        {{-- <td>
                                            @foreach ($kategori->akun as $user)
                                        ...
                                        <td class="text-center">
                                            <a href="#"
                                                onclick="handleDelete('{{ $kategori->id }}', '{{ $kategori->nama_topik }}')"
                                            ...
                                            <a href="/kategori_masalah/{{ $kategori->id }}" class="btn btn-info btn-icon"
                                                title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4 ">
                    ...
                    <div class="text-secondary">Apakah anda yakin ingin menghapus kategori permasalahan : <span
                            class="fw-bolder" id="nama"></span>
                        ?
                    </div>
                </div>
                <form action="/kategori_masalah" method="POST">
                    @csrf
                    @method('delete')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Kategori Permasalahan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="/kategori_masalah" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row mb-3 align-items-end">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label required">Nama Kategori Masalah</label>
                                    <input type="text" class="form-control @error('nama_topik') is-invalid @enderror"
                                        name="nama_topik" placeholder="Masukan Nama Kategori Masalahi"
