                                ...
                                @foreach ($divisis as $divisi)
                                    <tr class="align-middle">
                                        ...
                                        <td class="text-center">
                                            <a href="#"
                                                onclick="handleDelete('{{ $divisi->id }}', '{{ $divisi->nama_divisi }}')"
                                            ...
                                            <a href="/divisi/{{ $divisi->id }}" class="btn btn-info btn-icon"
                                                title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4 ">
                    ...
                    <div class="text-secondary">Apakah anda yakin ingin menghapus divisi bernama <span class="fw-bolder"
                            id="nama"></span>
                        ?
                    </div>
                </div>
