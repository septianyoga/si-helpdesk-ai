...
<body class=" d-flex flex-column">
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <form class="card card-md" action="/reset_pass" method="post" autocomplete="off" novalidate>
                @csrf
                <input type="hidden" name="token" value="{{ $token }}">
                <div class="card-body">
                    <h2 class="card-title text-center mb-4">Masukan Password Baru</h2>
                    <p class="text-secondary mb-4">Silahkan masukan password baru untuk mereset password.</p>
                    <div class="mb-3">
